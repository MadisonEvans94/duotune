		...
		<>
			<svg
				...
				<g transform="translate(451.76239464738063 277.3923827674436)">
					<path
						id="blob-path"
						d="M96.9 -100.4C123 -70.7 140 -35.4 157.7 17.7C175.4 70.7 193.8 141.4 167.6 175.8C141.4 210.1 70.7 208 5.5 202.5C-59.6 197 -119.3 187.9 -151.4 153.6C-183.6 119.3 -188.3 59.6 -181.5 6.8C-174.6 -46 -156.3 -91.9 -124.1 -121.6C-91.9 -151.3 -46 -164.6 -5.3 -159.3C35.4 -154 70.7 -130 96.9 -100.4"
						fill="#BB004B"></path>
				</g>
			</svg>
		</>
