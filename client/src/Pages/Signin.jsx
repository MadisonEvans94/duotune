						...
						<div className="mt-6">
							<form
								...
								<div className="flex items-center justify-between">
									<div className="flex items-center">
										<input
											...
											name="remember-me"
											type="checkbox"
											className="h-4 w-4 rounded border-gray-300 text-info focus:ring-dark"
										/>
										<label
											htmlFor="remember-me"
									...
									<div className="text-sm">
										<a
											href="https://google.com"
											className="font-medium text-accent  transition ">
								...
								<motion.button
									...
									type="submit"
									className="flex w-full justify-center rounded-md bg-accent px-3 py-2 text-sm font-semibold text-white shadow-sm transition focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
									Sign in
								</motion.button>
